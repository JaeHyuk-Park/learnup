...
<body>
	...
	<section class= "lows">
			...
			<div style="width:100%; height:100%; background-color:#3F0099; float: left;">
				<div style="width:100%; height:100%; margin:auto; margin:25px auto;">
...
<section class= "jaeneung">
		...
		<div class="boxxxxd">
			<div style="float: left "><span style="color: #8A2BE2; font-size: 20pt; position: relative; top: 10px; left: 50px; font-weight:bold;">위클리 재능 추천</span></div>
			<div style="text-align: right;"><button class="custom-btn btn-15" onclick="location.href='talentindexpage.html' " style="background-color: #D1B2FF; border-radius: 5px; position: relative; top: 30px; right: 60px; font-size: 15px; font-weight: bold; padding: 5px 10px;">전체보기</button></div>
		</div>
		<div class="link-boxd">
		...
		<div class="box-0d" >
			<div class="box-0-1d">
				<a href="" class="imgbox">
					<span style="position : absolute;">
						<img src="image/talentimage/13.jpg" id="talent-1" alt="" class="imgs">
					</span>
			...
			<div class="box-0-1d">
				<a href="" class="imgbox">
					<span style="position : absolute;">
						<img src="image/talentimage/14.jpg" id="talent-2" alt="" class="imgs">
					</span>
					<span style="position : absolute; margin-left: 200px;">
						<a href="javascript:;" class="icon heart" style="text-decoration:none; color:inherit; cursor:pointer;">
							<img src="image/heart1.png" alt="찜하기">
			...
			<div class="box-0-1d">
				<a href="" class="imgbox">
					<span style="position : absolute;">
						<img src="image/talentimage/17.jpg" id="talent-3" alt="" class="imgs">
					</span>
					<span style="position : absolute; margin-left: 200px;">
						<a href="javascript:;" class="icon heart" style="text-decoration:none; color:inherit; cursor:pointer;">
							<img src="image/heart1.png" alt="찜하기">
			...
			<div class="box-0-1d">
				<a href="" class="imgbox">
					<span style="position : absolute;">
						<img src="image/talentimage/18.jpg" id="talent-4" alt="" class="imgs">
					</span>
					<span style="position : absolute; margin-left: 200px;">
						<a href="javascript:;" class="icon heart" style="text-decoration:none; color:inherit; cursor:pointer;">
							<img src="image/heart1.png" alt="찜하기">
...
<section class= "off">
		...
		<div class="off_box">
			<div style="float: left "><span style="color: #8A2BE2; font-size: 20pt; position: relative; top: 10px; left: 50px; font-weight:bold;">위클리 오프라인 강의 추천</span></div>
			<div style="text-align: right;"><button class="custom-btn btn-15" onclick="location.href='talentindexpage.html' " style="background-color: #D1B2FF; border-radius: 5px; position: relative; top: 30px; right: 60px; font-size: 15px; font-weight: bold; padding: 5px 10px;">전체보기</button></div>
		</div>
		...
		<div class="box-0d3" >
			<div class="box-0-1d3">
				<a href="#self" class="imgbox">
					<span style="position : absolute;">
						<img src="image/lesson3.jpg" alt="" class="off_imgs">
					</span>
					<span style="position : absolute; margin-left: 200px;">
						<a href="javascript:;" class="icon heart" style="text-decoration:none; color:inherit; cursor:pointer;">
							<img src="image/heart1.png" alt="찜하기">
			...
			<div class="box-0-2d3">
				...
				<p class="off_title">그린컴퓨터아카데미 풀스텍(java, database, css, javascript)</p>
...
<section class= "janso">
		...
		<div class="janso_box">
			<div style="float: left "><span style="color: #8A2BE2; font-size: 20pt; position: relative; top: 10px; left: 50px; font-weight:bold;">위클리 오늘의 장소 추천</span></div>
			<div style="text-align: right;"><button class="custom-btn btn-15" onclick="location.href='talentindexpage.html' " style="background-color: #D1B2FF; border-radius: 5px; position: relative; top: 30px; right: 60px; font-size: 15px; font-weight: bold; padding: 5px 10px;">전체보기</button></div>
		</div>
		...
		<div class="box-controll2">
		 ...
		 <div class="box-0d2" style="margin-left:15px;">
 		  ...
 		  <a href="../html/heder.html" style=" text-decoration: none; box-sizing: border-box; ">
            <div class="box-0-2d2" >
                ...
                <span style="font-size: 12px; padding-top:10px;">(최소인원 1명/ </span>
                <span style="font-size: 12px; padding-top:10px;">최대인원 8명) </span>
		 ...
		 <div class="box-0d2">
			<div class="box-0-1d2"  >
          	  <a href="../html/heder.html" style=" text-decoration: none; box-sizing: border-box; ">
	        	<span style="position : absolute;">
					<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTh8GOP5muHYDSNl1Labrcriqk0QEBqAi_6LQ&usqp=CAU"  id="tab-4"  alt="" class="janso_img">
				</span>
				<span style="position : absolute; margin-left: 200px;">
					<a href="javascript:;" class="icon heart" style="text-decoration:none; color:inherit; cursor:pointer;">
						<img src="image/heart1.png" alt="찜하기">
