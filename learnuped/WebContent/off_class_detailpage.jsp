				...
				<div class="leftsec">
					<div class="detailWrap">
						...
						<div class="detail_note">
							공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>
							공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>
							공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>공지사항<br>
						</div>
					</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>
							클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>
							클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>클래스 요약<br>
						</div>
					</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>
							이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>
							이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>이런분들이 들으면 좋아요<br>
						</div>
					</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							...
							<div class="notetop">
								강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>
								강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>
								강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>강사님을 소개합니다.<br>
							</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							...
							<div class="notetop">
								어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>
								어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>어떤 클래스인가요?<br>
							</div>
						</div>
					</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>
							클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>
							클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>클래스 유의사항<br>
						</div>
					</div>
					...
					<div class="detailWrap">
						<div class="detail_title">
							<div class="movetit">	
								클래스는<br>이렇게<br>진행됩니다
							</div>
						</div>
						<div class="detail_note">
							<div>
								클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>
								클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>클래스는 이렇게 진행됩니다<br>
							</div>
					...
					<div class="detailWrap">
						...
						<div class="detail_note">
							수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>
							수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>
							수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>수강생 리뷰영역<br>
						</div>
					</div>
