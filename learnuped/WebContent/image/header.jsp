...
<title></title>
       ...
       %>
<body>
<div style="width:100%; height: 100%; margin-right: auto; margin-left: auto ; border-bottom: solid 1px black; ">
	<header>
		<div style="width: 1280px; height:45px; float:left; margin-top: 20px;">
			<nav style="width:150px; height:45px; float:left;">
				<a href="noticemain.jsp"><img src="image/widthlearn.png" style="width:155px; height:50px;"></a>
			</nav>
			<%if(email == null){ %>
		...
		<div style="width: 590px; height:40px; float:left; margin-top: 20px;">
			<a href="talentindexpage.html"><nav class="top_menu" style="margin-left:0px;"><div id="tm1">재능 판매</div></nav></a>
			<a href="off_mainpage.jsp"><nav class="top_menu"><div id="tm3">오프라인 강의</div></nav></a>
			<a href="../../wh/janso_main/janso_main.html"><nav class="top_menu" ><div id="tm4">장소 대여</div></nav></a>
		</div>
